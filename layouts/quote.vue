...
.slidev-layout.br-quote-slide-primary {
    background-image:
        radial-gradient(
            ellipse 90% 120% at -10% 50%,
            rgba(149, 71, 255, 0.28) 0%,
            transparent 55%
        ),
        radial-gradient(
            ellipse 60% 100% at 110% 50%,
            rgba(223, 249, 95, 0.06) 0%,
            transparent 60%
        );
}
.slidev-layout.br-quote-slide-secondary {
    background-image:
        radial-gradient(
            ellipse 90% 120% at -10% 50%,
            rgba(223, 249, 95, 0.22) 0%,
            transparent 55%
        ),
        radial-gradient(
            ellipse 60% 100% at 110% 50%,
            rgba(149, 71, 255, 0.06) 0%,
            transparent 60%
        );
}
...
.br-quote-primary {
    --bar: var(--br-primary);
    --mark: var(--br-secondary);
    --dot: var(--br-primary);
    --accent: var(--br-secondary);
    --glow: rgba(149, 71, 255, 0.45);
}
.br-quote-secondary {
    --bar: var(--br-secondary);
    --mark: var(--br-primary);
    --dot: var(--br-secondary);
    --accent: var(--br-secondary);
    --glow: rgba(223, 249, 95, 0.35);
}
.br-quote-accent {
    --bar: var(--br-accent);
    --mark: var(--br-secondary);
